 ...
 */
final class Version20220713123621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD variety_id INT DEFAULT NULL, CHANGE type_id type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP variety_id, CHANGE type_id type_id INT NOT NULL');
    }
}
