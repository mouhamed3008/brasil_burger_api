...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "cmd_read", "type_read", "product:write", 'livraison:read','livreur:read', "livreur:subresource", "menu:write"])]
    #[ORM\Column(type: 'string', length: 255)]
    private $libelle;

    #[Assert\NotBlank(message:"Le prix ne doit pas etre vide")]
    #[Groups(["product_read","gestion_read", "cmd_read", "product:write", "menu:write"])]
    #[ORM\Column(type: 'integer')]
    private $prix=1000;
    ...
    #[Groups(["product:write", "menu:write"])]
    #[Assert\NotBlank(message:"Veuillez choisir une image")]
    #[SerializedName('image')]
    private $imageFile;


    #[Groups(["product_read", "product:write", "menu:write"])]
    ...
    public function getVariety(): ?TypeTaille
    {
        return $this->variety;
    }

    public function setVariety(?TypeTaille $variety): self
    {
