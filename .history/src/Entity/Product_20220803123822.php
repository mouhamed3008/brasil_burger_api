...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "cmd_read", "type_read", "product:write", 'livraison:read','livreur:read', "livreur:subresource", "typetaille:read"])]
    ...
    #[Groups(["product_read", "typetaille:read"])]
    ...
    #[Groups(["product_read","gestion_read", "product:write", "type_read"])]
    #[ApiSubresource()]
