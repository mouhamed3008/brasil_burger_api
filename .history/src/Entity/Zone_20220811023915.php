...
use App\Controller\ZoneCmdController;
use App\Controller\ZoneCmdDetailController;
...
#[ApiResource(
    ...
    collectionOperations:['GET', 'POST',
        'ZONE_CMD'=>[
            'method' => 'GET',
            'path' => "/zonesC",
            'controller'=>ZoneCmdController::class,
            'groups'=>['ZONE_CMD']
        ],
        'ZONE_CMD-DETAIL'=>[
            'method' => 'GET',
            'path' => "/zonesC/{id}",
            'controller'=>ZoneCmdDetailController::class,
            'groups'=>['ZONE_CMD']
        ]
...
class Zone
{
    ...
    #[Groups(["quartier:write", "livraison:write", 'cmd:write', 'zone:read', 'cmd_read', 'livreur:read'])]
    private $id;
