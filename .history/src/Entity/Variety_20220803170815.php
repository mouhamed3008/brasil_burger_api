...
class Variety
{
    ...
    #[Groups(["variety:read", "typetaille:read", 'complement:read'])]
    #[ORM\Column(type: 'integer')]
    private $id;
    
    #[Assert\NotBlank(message:"Le libelle ne doit pas etre vide")]
    #[Groups(["variety:read", "prod:subresource", "typetaille:read", 'complement:read'])]
    ...
    #[Groups(["variety:read",  "prod:subresource", "typetaille:read"])]
