...
class Commande
{
    ...
    #[Groups(["type_read", "cmd_read", 'cmd_read', "commande:subresource", 'livraison:read', 'livreur:read'])]
    ...
    #[Groups(["cmd_read",  'cmd:write', "commande:subresource", 'livraison:read', 'livreur:read'])]
