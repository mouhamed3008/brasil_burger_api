...
{
    #[Groups(["client:read", "gestion_read", "commande:subresource", 'cmd:write', 'cmd_read'])]
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column(type: 'integer')]
    protected $id;

    #[Groups([ "client:read","client:write", "commande:subresource", 'cmd_read', 'livreur:write'])]
    ...
    #[Groups(["client:read","client:write", "commande:subresource", 'livraison:read', 'gestion_read', 'cmd_read', "zone:read"])]
