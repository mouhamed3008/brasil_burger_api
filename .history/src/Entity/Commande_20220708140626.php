...
class Commande
{
    ...
    #[Groups(["livraison:write", "cmd_read", 'cmd_read', "commande:subresource"])]
    private $id;
    
    #[Groups(["type_read", "cmd_read", 'cmd_read', "commande:subresource"])]
    ...
    #[Groups(["cmd_read",  'cmd:write', "commande:subresource"])]
    ...
    #[Groups(['cmd:write',"commande:subresource"])]
