...
#[ApiFilter(SearchFilter::class,properties:["libelle"=>"partial","lastname","customer","commandeAt"])]
...
class Commande
{
    ...
    #[Groups(["livraison:write", "cmd_read", 'cmd_read', "commande:subresource", 'livraison:read', "livreur:subresource", "zone:read"])]
    private $id;
    
    #[Groups(["type_read", "cmd_read", 'cmd_read', "commande:subresource", 'livraison:read', 'livreur:read', "livreur:subresource", "zone:read"])]
    ...
    #[Groups(["cmd_read",  'cmd:write', "commande:subresource", 'livraison:read', 'livreur:read', "livreur:subresource", "zone:read"])]
    #[ORM\ManyToOne(targetEntity: Client::class, inversedBy: 'commandes')]
    #[ORM\JoinColumn(nullable: false)]
    private $client;

    #[Groups([ "commande:subresource", 'cmd_read', "cmd:write", "zone:read"])]
    ...
    #[Groups(['cmd:write', 'livraison:read', 'cmd_read'])]
    ...
    #[Groups([ "commande:subresource", 'cmd_read'])]
