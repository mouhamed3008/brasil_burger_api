...
class Commande
{
    ...
    #[Groups(["livraison:write", "cmd_read", 'cmd_read', "commande:subresource", 'livraison:read'])]
    private $id;
    
    #[Groups(["type_read", "cmd_read", 'cmd_read', "commande:subresource", 'livraison:read'])]
    ...
    #[Groups(["cmd_read",  'cmd:write', "commande:subresource", 'livraison:read'])]
    ...
    #[Groups(['cmd:write',"commande:subresource", 'livraison:read'])]
