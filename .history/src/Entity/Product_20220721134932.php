...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "product:write", 'livraison:read', "livreur:subresource", 'menu:read'])]
    private $id;

    #[Assert\NotBlank(message:"Le libelle ne doit pas etre vide")]
    #[Groups(["product_read","gestion_read", "cmd_read", "type_read", "product:write", 'livraison:read','livreur:read', "livreur:subresource", 'menu:read'])]
