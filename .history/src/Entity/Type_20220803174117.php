...
class Type
{
    ...
    #[Groups(["catalogue:write", "product:write", "type_read", 'complement:read'])]
    private $id;
    
    #[Groups(["type_read", "product_read", "type:write", 'complement:read'])]
    ...
    /**
     * Get the value of typeTailles
     */ 
    public function getTypeTailles()
    {
        return $this->typeTailles;
    }

    /**
     * Set the value of typeTailles
     *
     * @return  self
     */ 
    public function setTypeTailles($typeTailles)
    {
        $this->typeTailles = $typeTailles;
