...
class TypeTaille
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[Groups(["cmd:write","prod:subresource", "typetaille:read", "type_read", 'complement:read'])]
    #[ORM\Column(type: 'integer')]
    private $id;
 
   
    #[Groups(["product:write", "prod:subresource", "typetaille:read", "type_read", 'complement:read'])]
    ...
    #[Groups(["product:write", "prod:subresource", "typetaille:read","type_read"])]
    #[ORM\ManyToOne(targetEntity: Variety::class, inversedBy: 'typeTailles', cascade:["persist"])]
    private $variety;

    #[Groups(["typetaille:read", "type_read"])]
