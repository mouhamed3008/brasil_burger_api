...
class User  implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Groups([ "client:read","client:write", "commande:subresource", 'cmd_read'])]
    ...
    #[Groups(["client:read","client:write", "commande:subresource", 'livraison:read', 'gestion_read', 'cmd_read'])]
    #[Assert\NotBlank(message:"Le téléphone ne doit pas etre vide")]
    #[ORM\Column(type: 'string', length: 255)]
    protected $telephone;


    #[Groups(["client:read","client:write", "commande:subresource", 'livraison:read', 'gestion_read'])]
