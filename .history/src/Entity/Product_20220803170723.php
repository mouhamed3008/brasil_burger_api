...
use App\Controller\ComplementController;
...
#[ApiResource(
    ...
    collectionOperations: [
        ...
        "COMPLEMENT"=>[
            ...
            'normalization_context' => ['groups' => 'complement:read'],
        ]
        ],
        subresourceOperations:[
            'products_get_subresource'=>[
                "method"=>"GET",
                "path"=>"products/{id}/varieties"
            ]
        ],
)]
...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "product:write", 'livraison:read', "livreur:subresource",'cmd:write', "typetaille:read"])]
    private $id;

    #[Assert\NotBlank(message:"Le libelle ne doit pas etre vide")]
    #[Groups(["product_read","gestion_read", "cmd_read", "type_read", "product:write", 'livraison:read','livreur:read', "livreur:subresource", "typetaille:read", 'complement:read'])]
    #[ORM\Column(type: 'string', length: 255)]
    private $libelle;

    #[Assert\NotBlank(message:"Le prix ne doit pas etre vide")]
    #[Groups(["product_read","gestion_read", "cmd_read", "product:write", 'complement:read'])]
    #[ORM\Column(type: 'integer')]
    private $prix=1000;

    // #[Groups(["product_read","gestion_read", "cmd_read"])]
    #[Groups(["product_read", "typetaille:read", "cmd_read", 'complement:read'])]
    ...
    #[Groups(["product_read", "product:write", 'complement:read'])]
    ...
    #[Groups(["product_read","gestion_read", "product:write", 'complement:read'])]
    #[ApiSubresource()]
