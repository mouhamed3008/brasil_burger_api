...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "product:write", 'livraison:read', "livreur:subresource",'cmd:write'])]
    private $id;
    ...
    #[Groups(["product_read","gestion_read", "product:write", "prod:subresource"])]
    #[ApiSubresource()]
