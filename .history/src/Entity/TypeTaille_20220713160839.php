...
class TypeTaille
{
    ...
    #[ORM\ManyToOne(targetEntity: Type::class, inversedBy: 'typeTailles', ascade:["persist"])]
    private $type;

    #[Groups(["product:write"])]
    #[ORM\ManyToOne(targetEntity: Taille::class, inversedBy: 'typeTailles', ascade:["persist"])]
    private $taille;
