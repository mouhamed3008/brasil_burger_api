...
use App\Controller\LivraisonPutController;
...
#[ApiResource(
    ...
    collectionOperations:['GET', 'POST',
        ...
        'RETOUR'=>[
            'method' => 'PUT', 
            'path' => "/livraisonRet/{id}",
            'controller'=>LivraisonPutController::class,
        ],
],
    itemOperations:[
    ...
    subresourceOperations:[
        'api_livreurs_livraisons_get_subresource'=>[
            "normalization_context"=>["groups"=>["livreur:subresource"]]
        ]
    ],
)]
class Livraison
{
    ...
    #[Groups(["livraison:write", 'livraison:read', 'livreur:read', "livreur:subresource"])]
    private $commandes;

    #[Groups(["livraison:write", "livreur:subresource"])]
