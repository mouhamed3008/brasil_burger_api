...
class Product
{
    ...
    #[Groups(["product_read","gestion_read", "product:write", 'livraison:read'])]
    private $id;

    #[Groups(["product_read","gestion_read", "cmd_read", "type_read", "product:write", 'livraison:read','livreur:read'])]
