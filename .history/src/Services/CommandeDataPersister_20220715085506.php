    ...
    public function persist($data, array $context = [])
    {
        ...
        dd($data->getLigneDeCommandes());
         ...
         foreach ($data->getLigneDeCommandes() as $product){
            dd($product->getProducts()->getTypeTaille());
        ...
        //         return new JsonResponse(['error'=>'Stock de '.$product->getProducts()->getVariety()->getVariety()->getLibelle().' insuffisant, il reste '.$product->getProducts()->getVariety()->getStock()], Response::HTTP_BAD_REQUEST);
        //         }
        //     }
