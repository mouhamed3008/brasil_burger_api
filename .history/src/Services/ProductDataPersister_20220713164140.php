...
class ProductDataPersister implements ContextAwareDataPersisterInterface
{
    ...
    public function persist($data, array $context = [])
    {
        ...
        $tailleType = new TypeTaille();
        
        $tailleType->setVariety($data->getVariety()->getVariety());
        $tailleType->setTaille($data->getVariety()->getTaille());
        $tailleType->setType($data->getVariety()->getTaille());
